  ...
  React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          Button,
          { variant: 'secondary-blue', size: 'small' },
          'Q & A'
        ),
        React.createElement(
          Button,
        ...
        React.createElement(Button, {
          ...
          variant: 'flat',
          size: 'small',
          icon: React.createElement(More16, null)
        })
      )
    ),
    React.createElement(
...
const TableExpandableRowsExample = () => {
  ...
  const handleExpandClick = id => {
    ...
    setExpandedData(
      Object.assign(Object.assign({}, expandedData), { [id]: !expanded })
    )
  }
    ...
    React.createElement(
      ...
      data.map(({ id, task, relatedTo, time, assignee }) =>
        React.createElement(
          ...
          {
            key: id,
            content: React.createElement(ExpandableContent, null),
          ...
          React.createElement(
            ...
            React.createElement(Button, {
              ...
              variant: 'flat',
              size: 'small',
              icon: React.createElement(Star16, null)
            }),
            React.createElement(Button, {
              circular: true,
              variant: 'flat',
              size: 'small',
              icon: React.createElement(StyledArrowDownMinor16, {
                expanded: expandedData[id]
              }),
