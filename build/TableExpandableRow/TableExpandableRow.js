...
export const TableExpandableRow = forwardRef(function TableExpandableRow(props, ref) {
    ...
    const { children, content, expanded, stripeEven, className, style } = props, rest = __rest(props, ["children", "content", "expanded", "stripeEven", "className", "style"]);
    const row = (React.createElement(TableRow
    // eslint-disable-next-line react/jsx-props-no-spreading
    , Object.assign({}, rest, { ref: ref, className: className, style: style, stripeEven: stripeEven }), children));
    return (React.createElement(Fragment, null,
        row,
        expanded && (React.createElement(TableRow, { className: cx(className, {
                [classes.stripeEven]: stripeEven
            }), style: style },
            React.createElement(TableCell, { colSpan: MAX_COL_SPAN },
