...
exports.Stepper = props => {
    const { active, steps, fullWidth, hideLabels, classes, className, style } = props, rest = __rest(props, ["active", "steps", "fullWidth", "hideLabels", "classes", "className", "style"]);
    return (react_1.default.createElement(Stepper_1.default
    // eslint-disable-next-line react/jsx-props-no-spreading
    , Object.assign({}, rest, { activeStep: active, connector: react_1.default.createElement(StepConnector_1.default, null), className: classnames_1.default({
