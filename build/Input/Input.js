...
const LimitAdornment = props => {
  ...
  return React.createElement(
    InputAdornment,
    { position: 'end', className: multiline ? classes.counterMultiline : '' },
    React.createElement(
      'span',
      {
...
const StartAdornment = ({ icon, iconPosition, disabled }) => {
  ...
  return React.createElement(IconAdornment, {
    disabled: disabled,
    position: 'start',
    icon: icon
  })
...
const EndAdornment = props => {
  ...
  if (hasCounter(counter, limit)) {
    return React.createElement(LimitAdornment, {
...
export const Input = forwardRef(function Input(props, ref) {
  ...
  return React.createElement(
    OutlinedInput,
    {
      ...
      startAdornment:
        startAdornment ||
        React.createElement(StartAdornment, {
          icon: icon,
      ...
      endAdornment:
        endAdornment ||
        React.createElement(EndAdornment, {
          icon: icon,
          iconPosition: iconPosition,
          disabled: disabled,
          limit: limit,
