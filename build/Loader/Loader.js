...
exports.Loader = react_1.forwardRef(function Loader(_a, ref) {
    ...
    return (react_1.default.createElement("div", Object.assign({}, rest, { ref: ref, className: classnames_1.default(classes.wrapper, className, {
