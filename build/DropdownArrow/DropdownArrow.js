...
exports.DropdownArrow = react_1.forwardRef(function DropdownArrow(_a, ref) {
    var { classes, className, style } = _a, rest = __rest(_a, ["classes", "className", "style"]);
    return (react_1.default.createElement("span", Object.assign({}, rest, { ref: ref, className: classnames_1.default(classes.root, className), style: style })));
});
