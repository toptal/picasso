...
export const PageHeaderMenu = forwardRef(function PageHeaderMenu(_a, ref) {
    ...
    const content = isSmallScreen ? (React.createElement(Fragment, null,
        ...
        children)) : (children);
    const trigger = isSmallScreen ? (React.createElement(Avatar, { size: 'xsmall', classes: {
            root: classes.avatar,
    ...
    , Object.assign({}, rest, { ref: ref, className: cx(classes.root, className), classes: { content: classes.content }, style: style, content: content, offset: { top: isSmallScreen ? 0.8 : 'xsmall' } }),
        trigger,
