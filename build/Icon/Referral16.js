...
const SvgReferral16 = (props) => {
    ...
    return (React.createElement("svg", { viewBox: '0 0 16 16', className: cx(classes.root, className), style: svgStyle, color: color },
        React.createElement("defs", null,
            React.createElement("path", { d: 'M14.5 6.793l.707.707L8.5 14.207l-.707-.707 6-6-6-6L8.5.793l6 6zm-7 0l.707.707L1.5 14.207.793 13.5l6-6-6-6L1.5.793l6 6z', id: 'referral16_svg__a' })),
        React.createElement("g", { fillRule: 'evenodd' },
            React.createElement("mask", { id: 'referral16_svg__b' },
                React.createElement("use", { xlinkHref: '#referral16_svg__a' })),
            React.createElement("use", { fillRule: 'nonzero', xlinkHref: '#referral16_svg__a' }),
            React.createElement("g", { mask: 'url(#referral16_svg__b)' },
