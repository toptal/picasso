...
const SvgCalendarReminder24 = forwardRef(function SvgCalendarReminder24(props, ref) {
    ...
    return (React.createElement("svg", { viewBox: '0 0 24 24', className: cx(...classes), style: svgStyle, color: svgColor, ref: ref },
        ...
        React.createElement("g", { fillRule: 'evenodd' },
            React.createElement("mask", { id: 'calendarReminder24_svg__b' },
                React.createElement("use", { xlinkHref: '#calendarReminder24_svg__a' })),
            React.createElement("use", { fillRule: 'nonzero', xlinkHref: '#calendarReminder24_svg__a' }),
            React.createElement("g", { mask: 'url(#calendarReminder24_svg__b)' },
