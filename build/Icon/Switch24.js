...
const BASE_SIZE = 24;
const SvgSwitch24 = forwardRef(function SvgSwitch24(props, ref) {
    ...
    return (React.createElement("svg", { viewBox: '0 0 24 24', className: cx(...classes), style: svgStyle, color: svgColor, ref: ref },
        ...
        React.createElement("g", { fillRule: 'evenodd' },
            React.createElement("mask", { id: 'switch24_svg__b' },
                React.createElement("use", { xlinkHref: '#switch24_svg__a' })),
            React.createElement("use", { fillRule: 'nonzero', xlinkHref: '#switch24_svg__a' }),
            React.createElement("g", { mask: 'url(#switch24_svg__b)' },
