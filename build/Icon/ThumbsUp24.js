...
const SvgThumbsUp24 = forwardRef(function SvgThumbsUp24(props, ref) {
    ...
    return (React.createElement("svg", { viewBox: '0 0 24 24', className: cx(...classes), style: svgStyle, color: svgColor, ref: ref },
        ...
        React.createElement("g", { fillRule: 'evenodd' },
            React.createElement("mask", { id: 'thumbsUp24_svg__b' },
                React.createElement("use", { xlinkHref: '#thumbsUp24_svg__a' })),
            React.createElement("use", { fillRule: 'nonzero', xlinkHref: '#thumbsUp24_svg__a' }),
            React.createElement("g", { mask: 'url(#thumbsUp24_svg__b)' },
