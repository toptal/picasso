...
const SvgFacebook16 = forwardRef(function SvgFacebook16(props, ref) {
    ...
    return (React.createElement("svg", { viewBox: '0 0 16 16', className: cx(...classes), style: svgStyle, color: svgColor, ref: ref },
        ...
        React.createElement("g", { fillRule: 'evenodd' },
            React.createElement("mask", { id: 'facebook16_svg__b' },
                React.createElement("use", { xlinkHref: '#facebook16_svg__a' })),
            React.createElement("use", { fillRule: 'nonzero', xlinkHref: '#facebook16_svg__a' }),
            React.createElement("g", { mask: 'url(#facebook16_svg__b)' },
