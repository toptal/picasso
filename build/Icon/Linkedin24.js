...
const BASE_SIZE = 24;
const SvgLinkedin24 = forwardRef(function SvgLinkedin24(props, ref) {
    ...
    return (React.createElement("svg", { viewBox: '0 0 24 24', className: cx(classes.root, className), style: svgStyle, color: color, ref: ref },
        ...
        React.createElement("g", { fillRule: 'evenodd' },
            React.createElement("mask", { id: 'linkedin24_svg__b' },
                React.createElement("use", { xlinkHref: '#linkedin24_svg__a' })),
            React.createElement("use", { fillRule: 'nonzero', xlinkHref: '#linkedin24_svg__a' }),
            React.createElement("g", { mask: 'url(#linkedin24_svg__b)' },
                React.createElement("path", { d: 'M0 0h24v24H0z' })))));
});
SvgLinkedin24.displayName = 'SvgLinkedin24';
export default withStyles(styles)(SvgLinkedin24);
