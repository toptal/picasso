...
const SvgReferralBonus24 = forwardRef(function SvgReferralBonus24(props, ref) {
    ...
    return (React.createElement("svg", { viewBox: '0 0 24 24', className: cx(classes.root, className), style: svgStyle, color: color, ref: ref },
        ...
        React.createElement("g", { fillRule: 'evenodd' },
            React.createElement("mask", { id: 'referralBonus24_svg__b' },
                React.createElement("use", { xlinkHref: '#referralBonus24_svg__a' })),
            React.createElement("use", { fillRule: 'nonzero', xlinkHref: '#referralBonus24_svg__a' }),
            React.createElement("g", { mask: 'url(#referralBonus24_svg__b)' },
