...
const SvgEducation16 = forwardRef(function SvgEducation16(props, ref) {
    ...
    return (React.createElement("svg", { viewBox: '0 0 16 16', className: cx(classes.root, className), style: svgStyle, color: color, ref: ref },
        ...
        React.createElement("g", { fillRule: 'evenodd' },
            React.createElement("mask", { id: 'education16_svg__b' },
                React.createElement("use", { xlinkHref: '#education16_svg__a' })),
            React.createElement("use", { fillRule: 'nonzero', xlinkHref: '#education16_svg__a' }),
            React.createElement("g", { mask: 'url(#education16_svg__b)' },
