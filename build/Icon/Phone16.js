...
const BASE_SIZE = 16;
const SvgPhone16 = forwardRef(function SvgPhone16(props, ref) {
    ...
    return (React.createElement("svg", { viewBox: '0 0 16 16', className: cx(...classes), style: svgStyle, color: svgColor, ref: ref },
        ...
        React.createElement("g", { fillRule: 'evenodd' },
            React.createElement("mask", { id: 'phone16_svg__b' },
                React.createElement("use", { xlinkHref: '#phone16_svg__a' })),
            React.createElement("use", { fillRule: 'nonzero', xlinkHref: '#phone16_svg__a' }),
            React.createElement("g", { mask: 'url(#phone16_svg__b)' },
