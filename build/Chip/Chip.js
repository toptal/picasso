...
const Chip = (_a) => {
    ...
    , Object.assign({}, htmlAttributes, { classes: restClasses, className: className, style: style, icon: icon, label: react_1.default.createElement("span", { className: innerLabel }, label), deleteIcon: deleteIcon, onDelete: onDelete })));
};
