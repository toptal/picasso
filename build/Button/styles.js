...
export default ({ palette, sizes, transitions, typography }) =>
  createStyles({
    root: {
      position: 'relative',
      textTransform: 'none',
    ...
    flat: Object.assign(
      Object.assign({}, secondary(palette.common.black, palette.common.white)),
      { border: 'none' }
    ),
    flatWhite: {
      color: palette.common.white,
    ...
    flatDisabled: Object.assign(
      Object.assign({}, secondary(palette.grey.light, palette.common.white)),
      { border: 'none' }
    ),
    // Other props
    fullWidth: {
