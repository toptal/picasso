...
export const Menu = forwardRef(function Menu(_a, ref) {
  var { children, className, classes, style, allowNestedNavigation } = _a,
    rest = __rest(_a, [
      'children',
      'className',
      'classes',
  ...
  const { backButtonIcon, hideMenu } = classes,
    restClasses = __rest(classes, ['backButtonIcon', 'hideMenu'])
  ...
  const menu = React.createElement(
    ...
    hasParentMenu &&
      ...
      React.createElement(
        MenuItem,
        { onClick: handleBackClick, key: 'back' },
        React.createElement(
          Typography,
          { size: 'small', color: 'dark-grey', variant: 'body' },
