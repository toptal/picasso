...
export const Autocomplete = forwardRef(function Autocomplete(_a, ref) {
  ...
  const optionsMenu = React.createElement(
    ScrollMenu,
    ...
    !optionsLength &&
      !shouldShowOtherOption &&
      React.createElement(Menu.Item, { disabled: true }, noOptionsText)
  )
  ...
  return React.createElement(
    ...
    React.createElement(
      Container,
      { flex: true, ref: inputWrapperRef },
      React.createElement(
        InputComponent,
        /* eslint-disable-next-line react/jsx-props-no-spreading */
        Object.assign({}, rest, getInputProps(), {
          error: error,
          icon: icon,
