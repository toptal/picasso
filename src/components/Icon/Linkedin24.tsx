...
const SvgLinkedin24 = (props: Props) => {
  const {
    classes,
    className,
    style = {},
    ...
    >
      <defs>
        <path
          ...
          id='linkedin24_svg__a'
        />
      </defs>
      <g fillRule='evenodd'>
        <mask id='linkedin24_svg__b'>
          <use xlinkHref='#linkedin24_svg__a' />
        </mask>
        <use fillRule='nonzero' xlinkHref='#linkedin24_svg__a' />
        <g mask='url(#linkedin24_svg__b)'>
