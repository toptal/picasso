...
const SvgInstagram24 = (props: Props) => {
    ...
    >
      <defs>
        <path
          ...
          id='instagram24_svg__a'
        />
      </defs>
      <g fillRule='evenodd'>
        <mask id='instagram24_svg__b'>
          <use xlinkHref='#instagram24_svg__a' />
        </mask>
        <use fillRule='nonzero' xlinkHref='#instagram24_svg__a' />
        <g mask='url(#instagram24_svg__b)'>
