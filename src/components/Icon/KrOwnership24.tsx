...
const SvgKrOwnership24 = forwardRef(function SvgKrOwnership24(
  props: Props,
...
SvgKrOwnership24.displayName = 'SvgKrOwnership24'
export default withStyles(styles)(SvgKrOwnership24)
