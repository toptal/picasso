...
const SvgInstagram16 = (props: Props) => {
  const { classes, className, style = {}, color, scale, size, base } = props

  if (size) {
    const name = 'SvgInstagram16'
  ...
  return (
    ...
    >
      ...
      <g fillRule='evenodd'>
        <mask id='instagram16_svg__b'>
          <use xlinkHref='#instagram16_svg__a' />
        </mask>
        <use fillRule='nonzero' xlinkHref='#instagram16_svg__a' />
        <g mask='url(#instagram16_svg__b)'>
