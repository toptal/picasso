...
const SvgCreditCar16 = (props: Props) => {
    ...
    >
      <defs>
        <path
          ...
          id='creditCar16_svg__a'
        />
      </defs>
      <g fillRule='evenodd'>
        <mask id='creditCar16_svg__b'>
          <use xlinkHref='#creditCar16_svg__a' />
        </mask>
        <use fillRule='nonzero' xlinkHref='#creditCar16_svg__a' />
        <g mask='url(#creditCar16_svg__b)'>
