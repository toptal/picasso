...
const SvgTwitter24 = (props: Props) => {
  const {
    classes,
    className,
    style = {},
  ...
  return (
    ...
    >
      ...
      <g fillRule='evenodd'>
        <mask id='twitter24_svg__b'>
          <use xlinkHref='#twitter24_svg__a' />
        </mask>
        <use fillRule='nonzero' xlinkHref='#twitter24_svg__a' />
        <g mask='url(#twitter24_svg__b)'>
