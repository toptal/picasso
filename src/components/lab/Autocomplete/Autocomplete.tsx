...
export const Autocomplete = forwardRef(function Autocomplete<T extends Item>(
  {
    classes,
    className,
    defaultInputValue,
  ...
  const downshiftStateReducer = (
    ...
    switch (changes.type) {
      ...
      case Downshift.stateChangeTypes.blurInput:
        ...
        if (allowAny && hasInput && inputValue !== getItemText(selectedItem)) {
          return {
            ...changes,
            inputValue,
            selectedItem: null
  ...
  const downshiftItemToString = (item: T | null) =>
    item === null
      ? allowAny
        ? inputValue
        : EMPTY_INPUT_VALUE
      ...
      {({
        ...
        const inputProps = getInputProps({
          ...
          onKeyDown: (event: KeyboardEvent<HTMLInputElement>) => {
            if (event.key === 'Backspace' && inputValue === EMPTY_INPUT_VALUE) {
              selectItem(null)
            }
