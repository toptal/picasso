...
describe('Tags', () => {
  it('renders with scroll buttons', () => {
    ...
    cy.get(`[data-testid="tab-3"]`).should('not.be.visible')
    cy.get('[data-testid="tab-scroll-button-left"]').should('not.be.visible')
    ...
    cy.get('[data-testid="tab-scroll-button-right"]').should('not.be.visible')
    cy.get('[data-testid="tabs"]').happoScreenshot()
