...
const config = {
  ...
  // See jest/react-compat/README.md. The input serializer must come first: it
  // prints a clone, and the clone lacks the "processed" marker the JSS
  // serializer sets — running after it would mangle class names twice.
  snapshotSerializers: [
