...
Remove the 'private' field from the package.json to publish it.`),
  ...
  console.log('@@@ before npmFetch', spec.escapedName, metadata, opts)
...
const buildMetadata = async (registry, manifest, tarballData, spec, opts) => {
  ...
  if (provenance === true || provenanceFile) {
    console.log('@@@ in provenance', provenance, provenanceFile)
    ...
    if (provenance === true) {
      ...
      console.log('publish', `Signed provenance statement with source and build information from ${ciInfo.name}`)
