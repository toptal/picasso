...
const SvgCloudDownloadBlue64 = forwardRef(function SvgCloudDownloadBlue64(
  props: Props,
  ...
  return (
    ...
    >
      <g clipPath='url(#a)'>
        ...
        <path
          opacity={0.15}
          d='M32 25.531V63.5a18.984 18.984 0 0 0 0-37.969Z'
          fill='#183A9E'
        />
        <path
        ...
        <path
          ...
          fill='#204ECF'
        />
        <path d='M40.725 52.139H23.278v1h17.447v-1Z' fill='#204ECF' />
        <path
          d='M32 53.095a.6.6 0 0 1-.423-.173l-8.654-8.655.707-.707L32 51.932l8.371-8.372.707.707-8.652 8.653a.606.606 0 0 1-.426.175Z'
          fill='#204ECF'
        />
        <path d='M32.5 35.188h-1v17.45h1v-17.45Z' fill='#204ECF' />
      </g>
      <defs>
        <clipPath id='a'>
...
SvgCloudDownloadBlue64.displayName = 'SvgCloudDownloadBlue64'
export default SvgCloudDownloadBlue64
