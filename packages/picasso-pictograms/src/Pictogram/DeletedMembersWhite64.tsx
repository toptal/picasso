...
const SvgDeletedMembersWhite64 = forwardRef(function SvgDeletedMembersWhite64(
  props: Props,
    ...
    >
      <g clipPath='url(#a)'>
        ...
        <path
          stroke='#fff'
          strokeMiterlimit={10}
          d='M49.21 46.75h-2.42l-1.73-9h5.88l-1.73 9Z'
        />
        <path
          fill='#000'
        ...
        <path
          stroke='#fff'
          strokeMiterlimit={10}
          d='M48 52.75a2.25 2.25 0 1 0 0-4.5 2.25 2.25 0 0 0 0 4.5Z'
        />
        <path
          stroke='#fff'
          strokeMiterlimit={10}
...
SvgDeletedMembersWhite64.displayName = 'SvgDeletedMembersWhite64'
export default SvgDeletedMembersWhite64
