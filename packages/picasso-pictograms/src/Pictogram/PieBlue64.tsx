...
const SvgPieBlue64 = forwardRef(function SvgPieBlue64(
  props: Props,
  ...
  return (
    ...
    >
      <g clipPath='url(#a)'>
        ...
        />
        <path fill='#204ECF' d='M48.293 28.688H32v1h16.293v-1Z' />
        <path
          fill='#204ECF'
...
SvgPieBlue64.displayName = 'SvgPieBlue64'
export default SvgPieBlue64
