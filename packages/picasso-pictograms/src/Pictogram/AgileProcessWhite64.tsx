...
const SvgAgileProcessWhite64 = forwardRef(function SvgAgileProcessWhite64(
  props: Props,
...
SvgAgileProcessWhite64.displayName = 'SvgAgileProcessWhite64'
export default SvgAgileProcessWhite64
