...
const SvgDashboardViewWhite64 = forwardRef(function SvgDashboardViewWhite64(
  props: Props,
    ...
    >
      <g clipPath='url(#a)'>
        <path
          ...
          opacity={0.3}
        />
        <path fill='#000' d='M59 32H20v7h39v-7Z' opacity={0.3} />
        <path
          stroke='#fff'
          strokeMiterlimit={10}
...
SvgDashboardViewWhite64.displayName = 'SvgDashboardViewWhite64'
export default SvgDashboardViewWhite64
