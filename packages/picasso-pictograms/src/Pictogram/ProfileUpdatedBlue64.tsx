...
const SvgProfileUpdatedBlue64 = forwardRef(function SvgProfileUpdatedBlue64(
  props: Props,
    ...
    >
      <g clipPath='url(#a)'>
        ...
        <path
          stroke='#204ECD'
          strokeMiterlimit={10}
          d='M21 18.5a5.5 5.5 0 1 0 0-11 5.5 5.5 0 0 0 0 11ZM12.5 29c0-4.69 3.81-8.5 8.5-8.5 4.69 0 8.5 3.81 8.5 8.5'
        />
        <path
          stroke='#204ECD'
          strokeMiterlimit={10}
...
SvgProfileUpdatedBlue64.displayName = 'SvgProfileUpdatedBlue64'
export default SvgProfileUpdatedBlue64
