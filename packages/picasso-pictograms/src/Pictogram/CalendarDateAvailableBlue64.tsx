...
const SvgCalendarDateAvailableBlue64 = forwardRef(
  function SvgCalendarDateAvailableBlue64(
    props: Props,
...
SvgCalendarDateAvailableBlue64.displayName = 'SvgCalendarDateAvailableBlue64'
export default SvgCalendarDateAvailableBlue64
