...
const SvgSecurityShieldBlue64 = forwardRef(function SvgSecurityShieldBlue64(
  props: Props,
  ...
  return (
    ...
    >
      <g clipPath='url(#a)'>
        <path fill='#183A9C' d='M41 31H22v11h19V31Z' opacity={0.15} />
        <path
          stroke='#204ECD'
          strokeMiterlimit={10}
...
SvgSecurityShieldBlue64.displayName = 'SvgSecurityShieldBlue64'
export default SvgSecurityShieldBlue64
