...
const SvgAerospaceWhite64 = forwardRef(function SvgAerospaceWhite64(
  props: Props,
    ...
    >
      <g clipPath='url(#a)'>
        ...
        <path
          ...
          fill='#fff'
        />
        <path d='M37.225 57.569h-10.45v1h10.45v-1Z' fill='#fff' />
        <path
...
SvgAerospaceWhite64.displayName = 'SvgAerospaceWhite64'
export default SvgAerospaceWhite64
