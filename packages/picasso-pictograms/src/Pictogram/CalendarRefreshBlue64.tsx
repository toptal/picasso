...
const SvgCalendarRefreshBlue64 = forwardRef(function SvgCalendarRefreshBlue64(
  props: Props,
  ...
  return (
    ...
    >
      <g clipPath='url(#a)'>
        ...
        />
        <path stroke='#204ECD' strokeMiterlimit={10} d='M43.5 25v4.5H39' />
        <path
          stroke='#204ECD'
          strokeMiterlimit={10}
        ...
        />
        <path stroke='#204ECD' strokeMiterlimit={10} d='m26 40 4 4 8.5-8.5' />
      </g>
      <defs>
        <clipPath id='a'>
...
SvgCalendarRefreshBlue64.displayName = 'SvgCalendarRefreshBlue64'
export default SvgCalendarRefreshBlue64
