...
const SvgCitySkylineWhite64 = forwardRef(function SvgCitySkylineWhite64(
  props: Props,
    ...
    >
      <g clipPath='url(#a)'>
        ...
        <path
          ...
          fill='#fff'
        />
        <path d='M19.89.5h-1v5.016h1V.5Z' fill='#fff' />
      </g>
      <defs>
        <clipPath id='a'>
...
SvgCitySkylineWhite64.displayName = 'SvgCitySkylineWhite64'
export default SvgCitySkylineWhite64
