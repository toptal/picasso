...
const SvgPlanetBlue64 = forwardRef(function SvgPlanetBlue64(
  props: Props,
  ...
  return (
    ...
    >
      <g clipPath='url(#a)'>
        ...
        />
        <path fill='#204ECF' d='M32.5 19.929h-1V32h1V19.929Z' />
        <path
          fill='#204ECF'
...
SvgPlanetBlue64.displayName = 'SvgPlanetBlue64'
export default SvgPlanetBlue64
