...
const SvgTechnologyBlue64 = forwardRef(function SvgTechnologyBlue64(
  props: Props,
...
SvgTechnologyBlue64.displayName = 'SvgTechnologyBlue64'
export default SvgTechnologyBlue64
