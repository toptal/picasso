...
const SvgConstructionBuildingWhite64 = forwardRef(
  function SvgConstructionBuildingWhite64(
    props: Props,
      ...
      >
        <g clipPath='url(#a)'>
          <path
            ...
            fill='#231F20'
          />
          <path d='M19 64H0v-9.196h19V64ZM1 63h17v-7.196H1V63Z' fill='#fff' />
          <path
          ...
          <path
            ...
            fill='#fff'
          />
          <path d='M46 .5h-1v48.055h1V.5Z' fill='#fff' />
          <path
            ...
            fill='#fff'
          />
          <path d='M58.07 11.948H8.375v1H58.07v-1Z' fill='#fff' />
        </g>
        <defs>
          <clipPath id='a'>
...
SvgConstructionBuildingWhite64.displayName = 'SvgConstructionBuildingWhite64'
export default SvgConstructionBuildingWhite64
