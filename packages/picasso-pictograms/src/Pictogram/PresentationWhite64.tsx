...
const SvgPresentationWhite64 = forwardRef(function SvgPresentationWhite64(
  props: Props,
...
SvgPresentationWhite64.displayName = 'SvgPresentationWhite64'
export default SvgPresentationWhite64
