...
const SvgDashboardSettingsWhite64 = forwardRef(
  function SvgDashboardSettingsWhite64(props: Props, ref: Ref<SVGSVGElement>) {
      ...
      >
        <g clipPath='url(#a)'>
          ...
          <path
            ...
            clipRule='evenodd'
          />
          <path stroke='#fff' strokeMiterlimit={10} d='m27 15 3.5 3.5L37 12' />
        </g>
        <defs>
          <clipPath id='a'>
...
SvgDashboardSettingsWhite64.displayName = 'SvgDashboardSettingsWhite64'
export default SvgDashboardSettingsWhite64
