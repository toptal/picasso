...
const SvgSpecializationDb16 = forwardRef(function SvgSpecializationDb16(
  props: Props,
  ...
  return (
    ...
    >
      <path
        className='specializationDB16_svg__cls-1'
...
SvgSpecializationDb16.displayName = 'SvgSpecializationDb16'
export default withStyles(styles)(SvgSpecializationDb16)
