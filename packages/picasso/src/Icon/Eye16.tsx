  ...
  return (
    ...
    >
      ...
      <g fill='none' fillRule='evenodd'>
        <mask id='eye16_svg__b' fill='#fff'>
          <use xlinkHref='#eye16_svg__a' />
        </mask>
        <use fill='#979797' fillRule='nonzero' xlinkHref='#eye16_svg__a' />
        <g mask='url(#eye16_svg__b)' fill='currentColor'>
