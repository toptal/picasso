  ...
  return (
    ...
    >
      ...
      <g fill='none' fillRule='evenodd'>
        <mask id='overview16_svg__b' fill='#fff'>
          <use xlinkHref='#overview16_svg__a' />
        </mask>
        <use fill='currentColor' xlinkHref='#overview16_svg__a' />
        <g mask='url(#overview16_svg__b)' fill='currentColor'>
