    ...
    >
      <defs>
        <path
          ...
          id='services16_svg__a'
        />
      </defs>
      <g fill='none' fillRule='evenodd'>
        <mask id='services16_svg__b' fill='#fff'>
          <use xlinkHref='#services16_svg__a' />
        </mask>
        <use
          fill='currentColor'
          fillRule='nonzero'
          xlinkHref='#services16_svg__a'
        />
        <g mask='url(#services16_svg__b)' fill='currentColor'>
