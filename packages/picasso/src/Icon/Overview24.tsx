  ...
  return (
    ...
    >
      ...
      <g fill='none' fillRule='evenodd'>
        <mask id='overview24_svg__b' fill='#fff'>
          <use xlinkHref='#overview24_svg__a' />
        </mask>
        <use fill='currentColor' xlinkHref='#overview24_svg__a' />
        <g mask='url(#overview24_svg__b)' fill='currentColor'>
