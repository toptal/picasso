    ...
    >
      <defs>
        <path
          ...
          id='profileCrossed24_svg__a'
        />
      </defs>
      <g fill='none' fillRule='evenodd'>
        <mask id='profileCrossed24_svg__b' fill='#fff'>
          <use xlinkHref='#profileCrossed24_svg__a' />
        </mask>
        <use
          fill='currentColor'
          fillRule='nonzero'
          xlinkHref='#profileCrossed24_svg__a'
        />
        <g mask='url(#profileCrossed24_svg__b)' fill='currentColor'>
