...
const SvgSpecializationWordPress16 = forwardRef(
  function SvgSpecializationWordPress16(props: Props, ref: Ref<SVGSVGElement>) {
    const {
    ...
    return (
      ...
      >
        <path
          className='specializationWordPress16_svg__cls-1'
...
SvgSpecializationWordPress16.displayName = 'SvgSpecializationWordPress16'
export default withStyles(styles)(SvgSpecializationWordPress16)
