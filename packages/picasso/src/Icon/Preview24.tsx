  ...
  return (
    ...
    >
      <g fill='#455065' fill-rule='evenodd' clip-rule='evenodd'>
        ...
        <path d='M11.54 8a3.494 3.494 0 0 0-3.488 3.5c0 1.933 1.562 3.5 3.489 3.5a3.494 3.494 0 0 0 3.489-3.5c0-1.933-1.562-3.5-3.49-3.5Zm-4.484 3.5c0-2.485 2.008-4.5 4.485-4.5a4.493 4.493 0 0 1 4.485 4.5c0 2.485-2.008 4.5-4.485 4.5a4.493 4.493 0 0 1-4.485-4.5Z' />
      </g>
    </svg>
  )
})
