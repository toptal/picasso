...
const SvgSpecializationRpa16 = forwardRef(function SvgSpecializationRpa16(
  props: Props,
  ...
  return (
    ...
    >
      <path
        className='specializationRPA16_svg__cls-1'
...
SvgSpecializationRpa16.displayName = 'SvgSpecializationRpa16'
export default withStyles(styles)(SvgSpecializationRpa16)
