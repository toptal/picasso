...
const useStyles = makeStyles(styles, { name: 'PicassoSvgInfo16' })
const SvgInfo16 = forwardRef(function SvgInfo16(
  ...
  return (
    <svg
      ...
      ref={ref}
    >
      <path d='M7.5 15a7.5 7.5 0 110-15 7.5 7.5 0 010 15zm0-1a6.5 6.5 0 100-13 6.5 6.5 0 000 13zM7 6h1v6H7V6zm0-3h1v1H7V3z' />
    </svg>
  )
})
