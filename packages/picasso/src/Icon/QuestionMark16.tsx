    ...
    >
      <defs>
        <path
          ...
          id='questionMark16_svg__a'
        />
      </defs>
      <g fill='none' fillRule='evenodd'>
        <mask id='questionMark16_svg__b' fill='#fff'>
          <use xlinkHref='#questionMark16_svg__a' />
        </mask>
        <use
          fill='currentColor'
          fillRule='nonzero'
          xlinkHref='#questionMark16_svg__a'
        />
        <g mask='url(#questionMark16_svg__b)' fill='currentColor'>
