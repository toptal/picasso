...
const useStyles = makeStyles(styles, { name: 'PicassoSvgVideoOn16' })
const SvgVideoOn16 = forwardRef(function SvgVideoOn16(
  ...
  return (
    <svg
      ...
      ref={ref}
    >
      <path d='M12 5.6L16 4v8l-4-1.6V13H0V3h12v2.6zm0 1.077v2.646l3 1.2V5.477l-3 1.2zM11 6V4H1v8h10V6z' />
    </svg>
  )
})
