    ...
    >
      <defs>
        <path
          ...
          id='pieChart24_svg__a'
        />
      </defs>
      <g fill='none' fillRule='evenodd'>
        <mask id='pieChart24_svg__b' fill='#fff'>
          <use xlinkHref='#pieChart24_svg__a' />
        </mask>
        <use fill='#979797' fillRule='nonzero' xlinkHref='#pieChart24_svg__a' />
        <g mask='url(#pieChart24_svg__b)' fill='currentColor'>
