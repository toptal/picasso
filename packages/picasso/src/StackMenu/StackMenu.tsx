...
import StackMenuContext, { StackMenuContextProps } from './StackMenuContext'
...
export interface StaticProps {
  Item: typeof StackMenuItem
}

type Menus = Record<string, ReactElement>

const useStyles = makeStyles<Theme>(styles, {
  name: 'PicassoStackMenu'
})

export const StackMenu = forwardRef<HTMLUListElement, Props>(
  function StackMenu (props, ref) {
    const {
      children,
      className,
      style,
    ...
    const { pop } = useContext<StackMenuContextProps>(StackMenuContext)
    ...
    const menuContext: StackMenuContextProps = useMemo(
      () => ({
    ...
    return (
      <StackMenuContext.Provider value={menuContext}>
