...
describe('removeClasses', () => {
  ...
  it('removes classes from html', () => {
    ...
    expect(removeAttributes(html)).toBe(expectedHtml)
  })
  it('removes classes from html with nesting', () => {
    const html = `<h3 class="nfj634-TextEditorTypography-headingMedium-288">Requirements</h3><ol><li><ol><li class="">Collaborate with PMs and other designers to ship your first product features.</li><li class="">Learn about our design system.</li></ol></li><li class="">Learn about our design system.</li></ol><h3 class="nfj634-TextEditorTypography-headingMedium-288">Requirements</h3><ul><li class="">Proficiency with various design and prototyping tools (such as Sketch, Abstract, Marvel, Principle, Figma), as well as knowledge of HTML and CSS.</li><li class="">An understanding that phenomenal experiences come from collaborative decision-making with front-end developers, engineers, researchers, content strategists, and other disciplines.</li></ul>`
    const expectedHtml = `<h3>Requirements</h3><ol><li><ol><li>Collaborate with PMs and other designers to ship your first product features.</li><li>Learn about our design system.</li></ol></li><li>Learn about our design system.</li></ol><h3>Requirements</h3><ul><li>Proficiency with various design and prototyping tools (such as Sketch, Abstract, Marvel, Principle, Figma), as well as knowledge of HTML and CSS.</li><li>An understanding that phenomenal experiences come from collaborative decision-making with front-end developers, engineers, researchers, content strategists, and other disciplines.</li></ul>`
