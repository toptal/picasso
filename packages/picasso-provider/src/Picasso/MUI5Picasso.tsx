...
import globalStyles from './mui5-styles'
...
import MUI5PicassoProvider from './MUI5PicassoProvider'
...
const MUI5Picasso = ({
  ...
  if (theme) {
    MUI5PicassoProvider.extendTheme(theme)
  }

  if (!responsive) {
    MUI5PicassoProvider.disableResponsiveStyle()
  ...
  return (
    <StylesProvider generateClassName={generateClassName}>
      <StyledEngineProvider injectFirst>
        <ThemeProvider theme={MUI5PicassoProvider.theme}>
