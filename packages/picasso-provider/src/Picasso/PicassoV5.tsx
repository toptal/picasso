...
import globalStyles from './styles-v5'
...
const PicassoV5 = ({
  ...
  if (theme) {
    PicassoProviderV5.extendTheme(theme)
  }

  if (!responsive) {
    PicassoProviderV5.disableResponsiveStyle()
  ...
  return (
    <StylesProvider generateClassName={generateClassName}>
      <StyledEngineProvider injectFirst>
        <ThemeProvider theme={PicassoProviderV5.theme}>
