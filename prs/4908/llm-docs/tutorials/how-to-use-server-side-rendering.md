...
### Remove PicassoProvider client side features
...
### Avoid using RichTextEditor component
...
### 1: Create an empty Next.js project

yarn create next-app --typescript

### 2: Add Picasso and PicassoProvider as a dependency

yarn add @toptal/picasso @toptal/picasso-provider

### 3: Wrap _app.tsx in PicassoProvider
...
### 4: Add server side stylesheet generation to _document.tsx
