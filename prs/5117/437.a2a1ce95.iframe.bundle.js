...
var useOnFocus = function (_ref) {
  ...
  var handleBlur = (0,react.useCallback)(function (e) {
    ...
    // this wrapper itself
    var isInternalElement = e.currentTarget.contains(focusElement) || internalRefs.some(function (ref) {
...
// whole editor
var EmojiMartPicker = /*#__PURE__*/(0,react.lazy)(function () {
  return Promise.all(/* import() */[__webpack_require__.e(225), __webpack_require__.e(634)]).then(__webpack_require__.bind(__webpack_require__, "./packages/picasso-rich-text-editor/src/RichTextEditorEmojiPicker/EmojiMartPicker.tsx"));
});
...
var RichTextEditorEmojiPicker = function (_ref) {
  ...
  var _React$useState3 = react.useState(false),
    _React$useState4 = RichTextEditorEmojiPicker_slicedToArray(_React$useState3, 2),
    pickerMounted = _React$useState4[0],
    setPickerMounted = _React$useState4[1];
  ...
  var closePicker = (0,react.useCallback)(function (event) {
    var _rootRef$current;
    // the toggle handles its own clicks, which emoji-mart reports as outside
    if (event.target instanceof Node && (_rootRef$current = rootRef.current) !== null && _rootRef$current !== void 0 && _rootRef$current.contains(event.target)) {
      return;
    }
    setShowEmojiPicker(false);
  }, []);
  var handleEmojiInsert = (0,react.useCallback)(function (emoji) {
    onInsertEmoji(emoji);
    setShowEmojiPicker(false);
  }, [onInsertEmoji]);
  (0,react.useEffect)(function () {
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsxs)(Container/* default */.A, {
    ...
    , {
      ...
      children: pickerMounted && /*#__PURE__*/(0,jsx_runtime.jsx)(react.Suspense, {
        fallback: null,
        children: /*#__PURE__*/(0,jsx_runtime.jsx)(EmojiMartPicker, {
          custom: customEmojis,
...
//# sourceMappingURL=437.a2a1ce95.iframe.bundle.js.map