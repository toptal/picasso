...
| getOperators | `((fields: Field[], fieldName: string) => Operator[])` | - | Defines a function that returns an array of operator objects that could be used to construct queries. |
