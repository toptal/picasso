...
'[&_ol.indent-level-2>li:not(.nested-list-item)]:[counter-increment:list-2]', "[&_ol.indent-level-2>li:not(.nested-list-item)]:before:content-[counter(list-2,lower-alpha)_'.']", `[&_ul.indent-level-2>li:not(.nested-list-item)]:before:[background-image:${outlinedBullet}]`,
// level 3 — lower-roman
...
'[&_ol.indent-level-4>li:not(.nested-list-item)]:[counter-increment:list-4]', "[&_ol.indent-level-4>li:not(.nested-list-item)]:before:content-[counter(list-4,decimal)_'.']", `[&_ul.indent-level-4>li:not(.nested-list-item)]:before:[background-image:${outlinedBullet}]`,
// level 5 — lower-alpha
...
//# sourceMappingURL=437.7f158b4e.iframe.bundle.js.map