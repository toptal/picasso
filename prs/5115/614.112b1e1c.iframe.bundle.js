"use strict";
(globalThis["webpackChunk_toptal_picasso_root"] = globalThis["webpackChunk_toptal_picasso_root"] || []).push([[614],{
...
var styles = {
  group: "flex items-center relative [pointer-events:unset] [&:not(:last-child):not(:empty)]:after:content-[''] [&:not(:last-child):not(:empty)]:after:h-[1em] [&:not(:last-child):not(:empty)]:after:w-px [&:not(:last-child):not(:empty)]:after:relative [&:not(:last-child):not(:empty)]:after:mx-[0.5em] [&:not(:last-child):not(:empty)]:after:bg-gray-200"
};
/* harmony default export */ const Toolbar_styles = (styles);
...
var group = "flex items-center relative [pointer-events:unset] [&:not(:last-child):not(:empty)]:after:content-[''] [&:not(:last-child):not(:empty)]:after:h-[1em] [&:not(:last-child):not(:empty)]:after:w-px [&:not(:last-child):not(:empty)]:after:relative [&:not(:last-child):not(:empty)]:after:mx-[0.5em] [&:not(:last-child):not(:empty)]:after:bg-gray-200";
...
/* harmony default export */ const RichTextEditorToolbar_styles = (styles_styles);
...
var RichTextEditorToolbar = /*#__PURE__*/(0,react.forwardRef)(function RichTextEditorToolbar(_ref, ref) {
  ...
  var classes = RichTextEditorToolbar_styles;
...
var FocusOnLabelClickPlugin_styles_styles = {
  hiddenInput: 'absolute opacity-0 z-[-1]'
};
/* harmony default export */ const FocusOnLabelClickPlugin_styles = (FocusOnLabelClickPlugin_styles_styles);
...
var FocusOnLabelClickPlugin = function (_ref) {
  ...
  var classes = FocusOnLabelClickPlugin_styles;
  var _useLexicalComposerCo = (0,LexicalComposerContext.useLexicalComposerContext)(),
...
var main = __webpack_require__("./node_modules/emoji-mart/dist/main.js");
...
var EmojiMartPicker = function (props) {
  ...
  var pickerRef = (0,react.useRef)(null);
  (0,react.useEffect)(function () {
    if (!pickerRef.current) {
      pickerRef.current = new main.Picker(Object.assign({}, props, {
        ref: containerRef
      }));
      return;
    }
...
EmojiMartPicker.displayName = 'EmojiMartPicker';
/* harmony default export */ const RichTextEditorEmojiPicker_EmojiMartPicker = (EmojiMartPicker);
try {
    // @ts-ignore
    EmojiMartPicker.displayName = "EmojiMartPicker";
    // @ts-ignore
    EmojiMartPicker.__docgenInfo = { "description": "Renders emoji-mart's `Picker` custom element.\n\n`Picker` appends itself to the element passed as `ref` and is fed prop\nchanges through `update`, so it is constructed after the first commit and\nupdated on every commit after that. An effect replay on the same instance\n(StrictMode, Fast Refresh) finds the picker still attached and updates it\ntoo, instead of constructing a second one.", "displayName": "EmojiMartPicker", "props": { "data": { "defaultValue": null, "description": "Emoji dataset to render, as exported by `@emoji-mart/data`", "name": "data", "required": true, "type": { "name": "unknown" } }, "custom": { "defaultValue": null, "description": "Additional groups of custom emojis appended to the picker", "name": "custom", "required": false, "type": { "name": "CustomEmojiGroup[] | undefined" } }, "onEmojiSelect": { "defaultValue": null, "description": "Called with the picked emoji when a selection is made", "name": "onEmojiSelect", "required": true, "type": { "name": "(emoji: Emoji) => void" } }, "onClickOutside": { "defaultValue": null, "description": "Called when a click lands outside the picker", "name": "onClickOutside", "required": false, "type": { "name": "(() => void) | undefined" } } } };
    // @ts-ignore
    if (typeof STORYBOOK_REACT_CLASSES !== "undefined")
        // @ts-ignore
...
var RichTextEditorEmojiPicker = function (_ref) {
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsxs)(Container/* default */.A, {
    ...
    , {
      ...
      children: /*#__PURE__*/(0,jsx_runtime.jsx)(RichTextEditorEmojiPicker_EmojiMartPicker, {
        data: _15_native,
        custom: customEmojis,
...
var BULLET_VAR = '--rte-bullet';
var OUTLINED_BULLET_VAR = '--rte-outlined-bullet';
var bullet = "url(\"data:image/svg+xml,%3Csvg%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%2016%2016'%3E%3Ccircle%20cx='8'%20cy='8'%20r='2'%20fill='%23455065'/%3E%3C/svg%3E\")";
var outlinedBullet = "url(\"data:image/svg+xml,%3Csvg%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%2016%2016'%3E%3Cpath%20fill-rule='evenodd'%20clip-rule='evenodd'%20d='M8%209c.55228%200%201-.44772%201-1s-.44772-1-1-1-1%20.44772-1%201%20.44772%201%201%201Zm0%201c1.10457%200%202-.89543%202-2s-.89543-2-2-2-2%20.89543-2%202%20.89543%202%202%202Z'%20fill='%23455065'/%3E%3C/svg%3E\")";
var listStyles = '[&_*:not(li)]:[counter-reset:list-0]';
var indentStyles = [
// level 2 — lower-alpha + outlined bullet (even level)
'[&_ol.indent-level-2>li:not(.nested-list-item)]:[counter-increment:list-2]', "[&_ol.indent-level-2>li:not(.nested-list-item)]:before:content-[counter(list-2,lower-alpha)_'.']", '[&_ul.indent-level-2>li:not(.nested-list-item)]:before:[background-image:var(--rte-outlined-bullet)]',
// level 3 — lower-roman
'[&_ol.indent-level-3>li:not(.nested-list-item)]:[counter-increment:list-3]', "[&_ol.indent-level-3>li:not(.nested-list-item)]:before:content-[counter(list-3,lower-roman)_'.']",
// level 4 — decimal + outlined bullet (even level)
'[&_ol.indent-level-4>li:not(.nested-list-item)]:[counter-increment:list-4]', "[&_ol.indent-level-4>li:not(.nested-list-item)]:before:content-[counter(list-4,decimal)_'.']", '[&_ul.indent-level-4>li:not(.nested-list-item)]:before:[background-image:var(--rte-outlined-bullet)]',
// level 5 — lower-alpha
'[&_ol.indent-level-5>li:not(.nested-list-item)]:[counter-increment:list-5]', "[&_ol.indent-level-5>li:not(.nested-list-item)]:before:content-[counter(list-5,lower-alpha)_'.']"].join(' ');
var margins = ['[&_p]:my-2 [&_code[dir]]:my-2', '[&_h3]:mt-4 [&_h3]:mb-2 [&_h3]:mx-0', '[&_p:first-child]:mt-0 [&_p:first-child]:mb-2 [&_p:first-child]:mx-0', '[&_h3:first-child]:mt-0 [&_h3:first-child]:mb-2 [&_h3:first-child]:mx-0', '[&_code[dir]:first-child]:mt-0 [&_code[dir]:first-child]:mb-2 [&_code[dir]:first-child]:mx-0', '[&_li:not(:last-child)]:mt-0 [&_li:not(:last-child)]:mb-2 [&_li:not(:last-child)]:mx-0', '[&_ol]:p-0 [&_ol]:my-2 [&_ol]:mx-0 [&_ul]:p-0 [&_ul]:my-2 [&_ul]:mx-0'].join(' ');
var editorContainer = ['h-[12.5em] overflow-y-hidden resize-y relative text-[14px]', listStyles, indentStyles, margins].join(' ');
var LexicalEditor_styles_styles = {
  editorContainer: editorContainer,
  // Padding is em-relative so it scales with the 14px editor font; fixed px
  // would not track the font size.
  contentEditable: 'outline-none h-full px-[0.5em] py-[1em] [tab-size:4] overflow-y-auto',
  placeholder: 'overflow-hidden absolute text-ellipsis top-0 left-0 select-none whitespace-normal inline-block pointer-events-none',
  paragraph: 'mt-0 mb-2 mx-0',
  listItem: 'list-none pl-6 relative before:inline-block before:absolute before:left-0 before:whitespace-nowrap before:w-4',
  ...
  code: components_styles/* codeStyles */.uX,
  codeBlock: `${components_styles/* codeBlockStyles */.PY} [&_*]:[font-family:monospace]`,
  codeBlockText: '[font-family:inherit] [font-size:inherit] leading-[inherit] text-inheritColor'
};
/* harmony default export */ const LexicalEditor_styles = (LexicalEditor_styles_styles);
...
//# sourceMappingURL=614.112b1e1c.iframe.bundle.js.map